...
public class ModFilter implements Filter {
	...
	if (debug) log("ModFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("ModFilter:DoAfterProcessing");
	...
	*/
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("ModFilter:Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("ModFilter()");
	StringBuffer sb = new StringBuffer("ModFilter(");
