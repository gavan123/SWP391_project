<%-- 
    Document   : AllMemberContent
    Created on : Jun 30, 2024, 2:18:15 PM
    Author     : admin
--%>
...
<!DOCTYPE html>
<a href="View Banned Member"><button class="btn btn-success">View Banned Member</button></a>
<div class="m-t-30">
                ...
                <c:choose>
                    <c:when test="${searchList == null}">
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-danger" onclick="togglePopup()">Ban</button> </td>                 
                    ...
                    %>
                    <td> 
                        <button class="btn btn-info" onclick="togglePopup2()">Unban</button>
