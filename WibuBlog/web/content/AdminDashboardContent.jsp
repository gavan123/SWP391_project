                                    ...
                                    <tbody>
                                       ...
                                       <% for(User x : pd.getTop10UserByPoint()){%>    
                                        ...
                                        <tr>
                                            ...
                                            <%if (x.getRoleId() == 3){%>
                                            <td> <button class="btn btn-success">Promote</button></td>
                                            <%}%>
                                            <%if (x.getRoleId() == 2){%>
                                            <td> <button class="btn btn-danger">Demote</button></td>
                                            <%}%>
                                            <%if (x.getRoleId() == 1){%>
                                            <td>N/A</td>
                                            <%}%>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="m-b-0">Ticket</h5>
                         <div>
                            <a href="ViewAll?Data=Ticket" class="btn btn-sm btn-default">View All</a>
                        </div>
                    </div>
                    <div class="m-t-30">
