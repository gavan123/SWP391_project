...
<html>
    <head>
        ...
        <link rel="stylesheet" href="assets/css/testcss1.css">
        <link rel="stylesheet" href="assets/css/testcss7.css">
        <style>
    ...
    <body>
        <jsp:include page="Layout.jsp">
            ...
            <jsp:param name="accountHeader" value="/content/AccountContent.jsp" />
             <jsp:param name="content" value="/content/AllMemberContent.jsp" />
        </jsp:include>
    </body>
